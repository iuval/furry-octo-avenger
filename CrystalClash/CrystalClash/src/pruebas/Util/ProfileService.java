...
public class ProfileService
{
	...
	private static final String PROFILE_DATA_FILE = ".crystal_clash/profile-v1.json";
	...
	{
		Gdx.app.log(CrystalClash.LOG, "Retrieving profile");
		...
		if (profileDataFile.exists()) {
			...
			try {
				...
				// log the exception
				Gdx.app.error(CrystalClash.LOG, "Unable to parse existing profile data file", e);
	...
	{
		Gdx.app.log(CrystalClash.LOG, "Persisting profile");
