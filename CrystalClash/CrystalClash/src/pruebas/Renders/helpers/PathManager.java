...
public class PathManager {
	...
	public static void load() {
		...
		SMALL_DOT_MOVE_TEXTURE = ResourceHelper.getTexture("in_game/action_dots/movement_small_dot.png");
		BIG_DOT_MOVE_TEXTURE = ResourceHelper.getTexture("in_game/action_dots/movement_big_dot.png");
		SMALL_DOT_ATTACK_TEXTURE = ResourceHelper.getTexture("in_game/action_dots/attack_small_dot.png");
		BIG_DOT_ATTACK_TEXTURE = ResourceHelper.getTexture("in_game/action_dots/attack_big_dot.png");
	}
