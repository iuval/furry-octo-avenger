...
public class ReadyGameListItem extends Group {
	public final String gameId;

	public ReadyGameListItem(String gameId, String playerName,
			Skin skin, EventListener surrenderListener, EventListener playListener) {
		this.gameId = gameId;
		...
		Label labelName = new Label(playerName, skin, "font", Color.WHITE);
		labelName.setPosition(getX() + buttonSurrender.getWidth() + 50, getY());
		labelName.setWidth(100);
		labelName.setAlignment(Align.center);
		addActor(labelName);

		TextButton buttonPlay = new TextButton("Play", skin.get("buttonStyle",
